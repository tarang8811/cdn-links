!(function (e) {
  ...
  function (e) {
    e.exports = JSON.parse(
      '{"selectTime":"Vælg Tid","selectDate":"Vælg dato","selectSlot":"Vælg et tidsrum fra de tilgængelige pladser","chooseDate":"Åh åh. Alle tidsrum er udfyldt for dagen. Vælg en anden dato","bookingConfirmed":"Aftalebestilling bekræftet","addToCart":"Tilføj til kurv","updateInCart":"Opdatering i kurv","checkout":"Kasse","allSelectedBookings":"Alle valgte reservationer","chooseVariant":"Vælg en variant","availableSlots":"Tilgængelige tidsrum","loading":"Indlæser","poweredBy":"Drevet af","redirectingToCheckout":"Omdirigerer til kassen","confirmationText":"Tilføjet til indkøbsvogn - Bekræftelse sendes efter køb","removeBooking":"Fjern reservation","bookingRemoved":"Reservationen blev fjernet fra vognen","bookingConfirmation":"Reservationsbekræftelse","back":"Tilbage","bookNow":"Book nu","bookViaCalendly":"Book via Calendly","calendlyBookingError":"Kalenderfejl ... Klik på ovenstående link for at booke","confirm":"Bekræfte","dateTime":"Dato tid","january":"januar","february":"februar","march":"marts","april":"April","may":"Maj","june":"juni","july":"juli","august":"august","september":"september","october":"oktober","november":"november","december":"december","sunday":"Søndag","monday":"Mandag","tuesday":"tirsdag","wednesday":"onsdag","thursday":"torsdag","friday":"Fredag","saturday":"lørdag","sun":"Søn","mon":"Man","tues":"Tir","wed":"Ons","thurs":"Tor","fri":"Fri","sat":"Lør","scheduleTime":"Planlæg din tid","availSlots":"tilgængelige tidsrum","noAvailSlots":"ingen ledige tidsrum","slotsRemaining":"resterende tidsrum","greaterQuantity":"Den valgte mængde er større end tilgængelige tidsrum. Reducer mængden, eller vælg en anden plads"}'
    )
  },
  function (e) {
    e.exports = JSON.parse(
      '{"selectTime":"Zeit auswählen","selectDate":"Datum auswählen","selectSlot":"Wählen Sie aus dem verfügbaren Zeitraum Ihren Wunschtermin aus","chooseDate":"Dieser Zeitraum  ist bereits belegt. Bitte wählen Sie ein anderes Datum aus","bookingConfirmed":"Terminbuchung bestätigt","addToCart":"In den Warenkorb","updateInCart":"Im Warenkorb aktualisieren","checkout":"Zur Kasse","allSelectedBookings":"Alle ausgewählten Buchungen","chooseVariant":"Wählen Sie eine Variante","availableSlots":"Verfügbare Zeiträume","loading":"Laden","poweredBy":"Powered By","redirectingToCheckout":"Weiterleitung zur Kasse","confirmationText":"Zum Warenkorb hinzugefügt - Bestätigung wird nach dem Kauf gesendet","removeBooking":"Buchung entfernen","bookingRemoved":"Gewählte Zeit vom Warenkorb entfernen","bookingConfirmation":"Buchungsbestätigung","back":"Zurück","bookNow":"Jetzt buchen","bookViaCalendly":"Über Calendly buchen","calendlyBookingError":"Kalenderfehler. Klicken Sie auf den obigen Link, um zu buchen","confirm":"Bestätigen","dateTime":"Datum & Uhrzeit","january":"Januar","february":"Februar","march":"März","april":"April","may":"Mai","june":"Juni","july":"Juli","august":"August","september":"September","october":"Oktober","november":"November","december":"Dezember","sunday":"Sonntag","monday":"Montag","tuesday":"Dienstag","wednesday":"Mittwoch","thursday":"Donnerstag","friday":"Freitag","saturday":"Samstag","sun":"So.","mon":"Mo.","tues":"Di.","wed":"Mi.","thurs":"Do.","fri":"Fr.","sat":"Sa.","scheduleTime":"Wählen Sie Ihre Zeit","availSlots":"Verfügbare Plätze","noAvailSlots":"Keine verfügbaren Plätze","slotsRemaining":"verbleibende Slots","greaterQuantity":"Die ausgewählte Menge ist größer als die verfügbaren Slots. Bitte verringern Sie die Menge oder wählen Sie einen anderen Steckplatz"}'
    )
  },
  function (e) {
    e.exports = JSON.parse(
  ...
  function (e) {
    e.exports = JSON.parse(
      '{"selectTime":"Seleccionar hora","selectDate":"Seleccione fecha","selectSlot":"Seleccione una franja horaria de las franjas horarias disponibles","chooseDate":"UH oh. Se han llenado todas las franjas horarias del día. Elija otra fecha","bookingConfirmed":"Reserva de cita confirmada","addToCart":"Añadir al carrito","updateInCart":"Actualizar en el carrito","checkout":"Revisa","allSelectedBookings":"Todas las reservas seleccionadas","chooseVariant":"Elija una variante","availableSlots":"Ranuras disponibles","loading":"Cargando","poweredBy":"Energizado por","redirectingToCheckout":"Redirigiendo a Checkout","confirmationText":"Agregado al carrito: la confirmación se enviará después de la compra","removeBooking":"Eliminar reserva","bookingRemoved":"Reserva eliminada del carrito","bookingConfirmation":"Confirmación de reserva","back":"atrás","bookNow":"Reservar ahora","bookViaCalendly":"Reserva vía Calendly","calendlyBookingError":"Error de Calendly ... Haga clic en el enlace de arriba para reservar","confirm":"Confirmar","dateTime":"Fecha y hora","january":"enero","february":"febrero","march":"marzo","april":"abril","may":"Mayo","june":"junio","july":"julio","august":"agosto","september":"septiembre","october":"octubre","november":"noviembre","december":"diciembre","sunday":"domingo","monday":"lunes","tuesday":"martes","wednesday":"miércoles","thursday":"jueves","friday":"viernes","saturday":"sábado","sun":"DOM","mon":"LUN","tues":"MAR","wed":"MIE","thurs":"JUE","fri":"VIE","sat":"SAB","scheduleTime":"Agenda tu hora","availSlots":"espacios disponibles","noAvailSlots":"no hay espacios disponibles","slotsRemaining":"ranuras restantes","greaterQuantity":"La cantidad seleccionada es mayor que los espacios disponibles. Disminuya la cantidad o elija otra ranura"}'
    )
  },
  function (e) {
    e.exports = JSON.parse(
      '{"selectTime":"Valitse aika","selectDate":"Valitse päivämäärä","selectSlot":"Valitse aikaväli saatavilla olevista ajoista","chooseDate":"Voi ei. Kaikki aikavälit on varattua valitsemallesi päivälle. Valitse toinen päivä.","bookingConfirmed":"Ajanvaraus vahvistettu","addToCart":"Lisää ostoskoriin","updateInCart":"Päivitä ostoskorissa","checkout":"Tarkista","allSelectedBookings":"Kaikki valitut varaukset","chooseVariant":"Valitse vaihtoehto","availableSlots":"Saatavilla olevat ajankohdat","loading":"Ladataan","poweredBy":"Powered by","redirectingToCheckout":"Uudelleenohjataan kassalle","confirmationText":"Lisätty ostoskoriin.","removeBooking":"Poista varaus","bookingRemoved":"Varaus poistettu ostoskorista","bookingConfirmation":"Varausvahvistus","back":"Takaisin","bookNow":"Varaa nyt","bookViaCalendly":"Varaa Calendlyn kautta","calendlyBookingError":"Calendly virhe ... Napsauta yllä olevaa linkkiä varataksesi","confirm":"Vahvista","dateTime":"Ajankohta","january":"Tammikuu","february":"Helmikuu","march":"Maaliskuu","april":"Huhtikuu","may":"Toukokuu","june":"Kesäkuu","july":"Heinäkuu","august":"Elokuu","september":"Syyskuu","october":"Lokakuu","november":"Marraskuu","december":"Joulukuu","sunday":"sunnuntai","monday":"maanantai","tuesday":"tiistai","wednesday":"keskiviikko","thursday":"torstai","friday":"perjantai","saturday":"lauantai","sun":"Su","mon":"Ma","tues":"Ti","wed":"Ke","thurs":"To","fri":"Pe","sat":"La","scheduleTime":"Aikatauluta","availSlots":"Vapaita aikoja","noAvailSlots":"Ei vapaita aikoja","slotsRemaining":"paikkaa jäljellä","greaterQuantity":"Valittu määrä on suurempi kuin käytettävissä olevat paikat. Vähennä määrää tai valitse toinen paikka"}'
    )
  },
  function (e) {
    e.exports = JSON.parse(
      '{"selectTime":"Sélectionnez l\'heure","selectDate":"Sélectionner une date","selectSlot":"Sélectionnez un créneau horaire parmi les créneaux disponibles","chooseDate":"Euh-Oh. Toutes les plages horaires ont été remplies pour la journée. Veuillez choisir une autre date","bookingConfirmed":"Réservation de rendez-vous confirmée","addToCart":"Ajouter au panier","updateInCart":"Mettre à jour dans le panier","checkout":"Check-out","allSelectedBookings":"Toutes les réservations sélectionnées","chooseVariant":"Choisissez une variante","availableSlots":"Emplacements disponibles","loading":"Chargement","poweredBy":"Alimenté par","redirectingToCheckout":"Redirection vers Checkout","confirmationText":"Ajouté au panier - La confirmation sera envoyée après l\'achat","removeBooking":"Supprimer la réservation","bookingRemoved":"Réservation supprimée du panier","bookingConfirmation":"Confirmation de réservation","back":"Retour","bookNow":"Reserve maintenant","bookViaCalendly":"Réservez via Calendly","calendlyBookingError":"Erreur Calendly ... Cliquez sur le lien ci-dessus pour réserver","confirm":"Confirmer","dateTime":"Date et heure","january":"janvier","february":"février","march":"Mars","april":"avril","may":"Mai","june":"juin","july":"juillet","august":"août","september":"septembre","october":"octobre","november":"novembre","december":"décembre","sunday":"dimanche","monday":"Lundi","tuesday":"Mardi","wednesday":"Mercredi","thursday":"Jeu","friday":"Vendredi","saturday":"samedi","sun":"Dim","mon":"Lun","tues":"Mar","wed":"Mer","thurs":"Jeu","fri":"Ven","sat":"Sam","scheduleTime":"Reserver","availSlots":"emplacements disponibles","noAvailSlots":"pas d\'emplacements disponibles","slotsRemaining":"emplacements restants","greaterQuantity":"La quantité sélectionnée est supérieure aux emplacements disponibles. Veuillez diminuer la quantité ou choisir un autre emplacement"}'
    )
  },
  function (e) {
    e.exports = JSON.parse(
  ...
  function (e) {
    e.exports = JSON.parse(
      '{"selectTime":"Veldu tímasetningu","selectDate":"Veldu dagsetningu","selectSlot":"Veldu tímann sem hentar þér af eftirfarandi lausum tímum","chooseDate":"Æ nei! Allir tímar dagsins eru uppbókaðir. Vinsamlegast veldu aðra dagsetningu","bookingConfirmed":"Tímabókun er staðfest","addToCart":"Bæta við körfu","updateInCart":"Uppfæra körfu","checkout":"Klára kaup","allSelectedBookings":"Allar valdar bókanir","chooseVariant":"Veldu afbrigði","availableSlots":"Tiltækir tímar","loading":"Hleður","poweredBy":"Keyrt áfram af","redirectingToCheckout":"Færi þig yfir á greiðsluform","confirmationText":"Bætt í körfu - Staðfesting verður send þegar gengið hefur verið frá greiðslu","removeBooking":"Fjarlægja bókun","bookingRemoved":"Bókun fjarlægð úr körfu","bookingConfirmation":"Bókun staðfest","back":"Til baka","bookNow":"Bóka núna","bookViaCalendly":"Bóka í gegnum Calendly","calendlyBookingError":"Villa hjá Calendly...smelltu á tengilinn að ofan til að bóka","confirm":"Staðfesta","dateTime":"Dagsetning og tími","january":"Janúar","february":"Febrúar","march":"Mars","april":"Apríl","may":"Maí","june":"Júní","july":"Júlí","august":"Ágúst","september":"September","october":"Október","november":"Nóvember","december":"Desember","sunday":"sunnudagur","monday":"mánudagur","tuesday":"þriðjudagur","wednesday":"miðvikudagur","thursday":"fimmtudagur","friday":"föstudagur","saturday":"laugardagur","sun":"Sun","mon":"Mán","tues":"Þri","wed":"Mið","thurs":"Fim","fri":"Fös","sat":"Lau","scheduleTime":"Skráðu tímann","availSlots":"Tiltækir tímar","noAvailSlots":"Engir tiltækir tímar","slotsRemaining":"Lausir tímar","greaterQuantity":"Fjöldinn sem er valinn er umfram þá tíma sem eru í boði. Vinsamlegast breyttu fjöldanum eða veldu annan tíma"}'
    )
  },
  function (e) {
    e.exports = JSON.parse(
      '{"selectTime":"Seleziona Ora","selectDate":"Seleziona la data","selectSlot":"Seleziona una fascia oraria dalle fasce orarie disponibili","chooseDate":"Uh Oh. Tutte le fasce orarie sono state occupate per la giornata. Scegli un\'altra data","bookingConfirmed":"Appuntamento Prenotazione confermata","addToCart":"Aggiungi al carrello","updateInCart":"Aggiorna nel carrello","checkout":"Check-out","allSelectedBookings":"Tutte le prenotazioni selezionate","chooseVariant":"Scegli una variante","availableSlots":"Slot disponibili","loading":"Caricamento in corso","poweredBy":"Offerto da","redirectingToCheckout":"Reindirizzamento a Checkout","confirmationText":"Aggiunto al carrello - La conferma verrà inviata dopo l\'acquisto","removeBooking":"Rimuovi prenotazione","bookingRemoved":"Prenotazione rimossa dal carrello","bookingConfirmation":"Conferma della prenotazione","back":"Indietro","bookNow":"Prenota ora","bookViaCalendly":"Prenota tramite Calendly","calendlyBookingError":"Calendly Error ... Clicca sul link qui sopra per prenotare","confirm":"Confermare","dateTime":"Appuntamento","january":"gennaio","february":"febbraio","march":"marzo","april":"aprile","may":"Maggio","june":"giugno","july":"luglio","august":"agosto","september":"settembre","october":"ottobre","november":"novembre","december":"dicembre","sunday":"Domenica","monday":"Lunedi","tuesday":"martedì","wednesday":"mercoledì","thursday":"giovedi","friday":"Venerdì","saturday":"Sabato","sun":"Sole","mon":"Mio","tues":"Tue","wed":"Mercoledì","thurs":"Gio","fri":"Ven","sat":"Sab","scheduleTime":"Pianifica il tuo tempo","availSlots":"slot disponibili","noAvailSlots":"nessuno slot disponibile","slotsRemaining":"slot disponibili","greaterQuantity":"La quantità selezionata è maggiore degli slot disponibili. Diminuisci la quantità o scegli un altro slot"}'
    )
  },
  function (e) {
    e.exports = JSON.parse(
      '{"selectTime":"時間の選択","selectDate":"日程を指定","selectSlot":"利用可能な空時間から選択します。","chooseDate":"申し訳ございませんがこの日は予定が既に埋まっております。他の日程をご覧ください。","bookingConfirmed":"予約確認済み","addToCart":"カートに入れる","updateInCart":"カート内の更新","checkout":"チェックアウト","allSelectedBookings":"選択したすべての予約","chooseVariant":"バリアントを選択","availableSlots":"空き時間","loading":"読み込み中","poweredBy":"搭載","redirectingToCheckout":"チェックアウトへのリダイレクト","confirmationText":"カートに追加-購入後に確認が送信されます","removeBooking":"予約を削除する","bookingRemoved":"カートから予約が削除されました","bookingConfirmation":"予約確認","back":"バック","bookNow":"今予約する","bookViaCalendly":"Calendly経由で予約","calendlyBookingError":"カレンダーエラー...予約するには上記のリンクをクリックしてください","confirm":"確認","dateTime":"日付時刻","january":"一月","february":"二月","march":"三月","april":"四月","may":"五月","june":"六月","july":"七月","august":"八月","september":"九月","october":"十月","november":"十一月","december":"十二月","sunday":"日曜日","monday":"月曜","tuesday":"火曜日","wednesday":"水曜日","thursday":"木曜日","friday":"金曜日","saturday":"土曜日","sun":"日","mon":"月","tues":"火","wed":"水","thurs":"木","fri":"金","sat":"土","scheduleTime":"予約する"}'
    )
  },
  function (e) {
    e.exports = JSON.parse(
  ...
  function (e) {
    e.exports = JSON.parse(
      '{"selectTime":"Velg Tid","selectDate":"Velg dato","selectSlot":"Velg en tidsluke fra de tilgjengelige sporene","chooseDate":"UH oh. Alle tidsluker er fylt ut for dagen. Velg en annen dato","bookingConfirmed":"Avtalebestilling bekreftet","addToCart":"Legg i handlekurv","updateInCart":"Oppdater i handlekurven","checkout":"Sjekk ut","allSelectedBookings":"Alle valgte bestillinger","chooseVariant":"Velg en variant","availableSlots":"Tilgjengelige spilleautomater","loading":"Laster inn","poweredBy":"Drevet av","redirectingToCheckout":"Viderekobler til kassen","confirmationText":"Lagt til i handlekurven - Bekreftelse vil bli sendt etter kjøp","removeBooking":"Fjern booking","bookingRemoved":"Bestilling fjernet fra handlekurven","bookingConfirmation":"Bestillingsbekreftelse","back":"Tilbake","bookNow":"Bestill nå","bookViaCalendly":"Bestill Via Calendly","calendlyBookingError":"Kalenderfeil ... Klikk på lenken ovenfor for å bestille","confirm":"Bekrefte","dateTime":"Dato tid","january":"januar","february":"februar","march":"mars","april":"april","may":"Kan","june":"juni","july":"juli","august":"august","september":"september","october":"oktober","november":"november","december":"desember","sunday":"søndag","monday":"mandag","tuesday":"tirsdag","wednesday":"onsdag","thursday":"Torsdag","friday":"fredag","saturday":"lørdag","sun":"Sol","mon":"Min","tues":"Hilsen din","wed":"Ons","thurs":"Torsdag","fri":"Fre","sat":"Lør","scheduleTime":"Planlegg tiden din"}'
    )
  },
  function (e) {
    e.exports = JSON.parse(
      '{"selectTime":"Vyberte Čas","selectDate":"Vyberte dátum","selectSlot":"Vyberte jeden časový slot z dostupných slotov","chooseDate":"Uh Oh. Všetky časové intervaly boli pre daný deň vyplnené. Vyberte iný dátum","bookingConfirmed":"Rezervácia termínu bola potvrdená","addToCart":"Pridať do košíka","updateInCart":"Aktualizácia v košíku","checkout":"Odhlásiť sa","allSelectedBookings":"Všetky vybrané rezervácie","chooseVariant":"Vyberte variant","availableSlots":"Dostupné automaty","loading":"Načítava","poweredBy":"Poháňaný","redirectingToCheckout":"Prebieha presmerovanie do služby Checkout","confirmationText":"Pridané do košíka - potvrdenie bude odoslané po zakúpení","removeBooking":"Odstrániť rezerváciu","bookingRemoved":"Rezervácia bola odstránená z košíka","bookingConfirmation":"Potvrdenie rezervácie","back":"späť","bookNow":"Rezervovať","bookViaCalendly":"Zarezervujte si Via Calendly","calendlyBookingError":"Chyba v kalendári ... Kliknutím na vyššie uvedený odkaz rezervujete","confirm":"Potvrdiť","dateTime":"Dátum Čas","january":"Januára","february":"Februára","march":"Marca","april":"Apríla","may":"Smieť","june":"Júna","july":"Júla","august":"Augusta","september":"September","october":"Októbra","november":"Novembra","december":"December","sunday":"nedeľa","monday":"pondelok","tuesday":"utorok","wednesday":"streda","thursday":"štvrtok","friday":"piatok","saturday":"sobota","sun":"slnko","mon":"Môj","tues":"Váš","wed":"St","thurs":"Štvrtok","fri":"Pia","sat":"Sob","scheduleTime":"Naplánujte si čas"}'
    )
  },
  function (e) {
    e.exports = JSON.parse(
      '{"selectTime":"Izberite Čas","selectDate":"Izberite Datum","selectSlot":"Med razpoložljivimi režami izberite eno časovno režo","chooseDate":"Ojoj. Vsa časovna mesta so bila zapolnjena za ta dan. Izberite drug datum","bookingConfirmed":"Rezervacija za termin je potrjena","addToCart":"Dodaj v voziček","updateInCart":"Posodobi v košarici","checkout":"Preveri","allSelectedBookings":"Vse izbrane rezervacije","chooseVariant":"Izberite varianto","availableSlots":"Na voljo reže","loading":"nalaganje","poweredBy":"Poganja ga","redirectingToCheckout":"Preusmeritev na blagajno","confirmationText":"Dodano v košarico - potrditev bo poslana po nakupu","removeBooking":"Odstrani rezervacijo","bookingRemoved":"Rezervacija odstranjena iz košarice","bookingConfirmation":"Potrditev rezervacije","back":"Nazaj","bookNow":"Rezervirajte zdaj","bookViaCalendly":"Rezervirajte Via Calendly","calendlyBookingError":"Napaka Calendly ... Kliknite zgornjo povezavo za rezervacijo","confirm":"Potrdite","dateTime":"Datum čas","january":"Januarja","february":"Februarja","march":"Marec","april":"April","may":"Maj","june":"Junij","july":"Julij","august":"Avgust","september":"September","october":"Oktober","november":"November","december":"December","sunday":"nedelja","monday":"ponedeljek","tuesday":"torek","wednesday":"sreda","thursday":"četrtek","friday":"petek","saturday":"sobota","sun":"Sonce","mon":"Moj","tues":"Vaš","wed":"Sre","thurs":"Četrtek","fri":"Pet","sat":"Sobota","scheduleTime":"Razporedite svoj čas"}'
    )
  },
  function (e) {
    e.exports = JSON.parse(
      '{"selectTime":"Välj Tid","selectDate":"Välj datum","selectSlot":"Välj en tidslucka från tillgängliga tider","chooseDate":"Hoppsan. Alla tidsluckor har fyllts i för dagen. Välj ett annat datum","bookingConfirmed":"Bokningsbokning bekräftad","addToCart":"Lägg till i kundvagn","updateInCart":"Uppdatering i kundvagn","checkout":"Bekräfta","allSelectedBookings":"Alla valda bokningar","chooseVariant":"Välj en variant","availableSlots":"Tillgängliga tider","loading":"Läser in","poweredBy":"Drivs av","redirectingToCheckout":"Omdirigerar till kassan","confirmationText":"Lagt till i kundvagnen - Bekräftelse skickas efter köp","removeBooking":"Ta bort bokningen","bookingRemoved":"Bokningen har tagits bort från vagnen","bookingConfirmation":"Bokningsbekräftelse","back":"Tillbaka","bookNow":"Boka nu","bookViaCalendly":"Boka via Calendly","calendlyBookingError":"Calendly Error ... Klicka på länken ovan för att boka","confirm":"Bekräfta","dateTime":"Datum Tid","january":"Januari","february":"Februari","march":"Mars","april":"April","may":"Maj","june":"Juni","july":"Juli","august":"Augusti","september":"September","october":"Oktober","november":"November","december":"December","sunday":"söndag","monday":"måndag","tuesday":"tisdag","wednesday":"onsdag","thursday":"torsdag","friday":"fredag","saturday":"lördag","sun":"Sön","mon":"Mån","tues":"Tis","wed":"Ons","thurs":"Tor","fri":"Fre","sat":"Lör","scheduleTime":"Boka tid","availSlots":"tillgängliga tider","noAvailSlots":"inga tillgängliga tider","slotsRemaining":"återstående tider","greaterQuantity":"Valt antal är större än tillgängliga tider. Minska antalet eller välj en annan plats"}'
    )
  },
  function (e) {
    e.exports = JSON.parse(
      '{"selectTime":"เลือกเวลา","selectDate":"เลือกวันที่","selectSlot":"เลือกช่วงเวลาหนึ่งจากช่องที่มีอยู่","chooseDate":"เอ่อโอ้. เต็มช่วงเวลาทั้งหมดของวันแล้ว โปรดเลือกวันอื่น","bookingConfirmed":"ยืนยันการจองการนัดหมาย","addToCart":"หยิบใส่รถเข็น","updateInCart":"อัปเดตในรถเข็น","checkout":"เช็คเอาท์","allSelectedBookings":"การจองที่เลือกทั้งหมด","chooseVariant":"เลือกตัวแปร","availableSlots":"สล็อตที่มีอยู่","loading":"กำลังโหลด","poweredBy":"ขับเคลื่อนโดย","redirectingToCheckout":"กำลังเปลี่ยนเส้นทางไปที่ Checkout","confirmationText":"เพิ่มลงในรถเข็น - การยืนยันจะถูกส่งหลังการซื้อ","removeBooking":"ลบการจอง","bookingRemoved":"การจองถูกลบออกจากรถเข็น","bookingConfirmation":"การยืนยันการจอง","back":"กลับ","bookNow":"จองตอนนี้","bookViaCalendly":"จองผ่าน Calendly","calendlyBookingError":"Calendly Error ... คลิกที่ลิงค์ด้านบนเพื่อจอง","confirm":"ยืนยัน","dateTime":"วันเวลา","january":"มกราคม","february":"กุมภาพันธ์","march":"มีนาคม","april":"เมษายน","may":"อาจ","june":"มิถุนายน","july":"กรกฎาคม","august":"สิงหาคม","september":"กันยายน","october":"ตุลาคม","november":"พฤศจิกายน","december":"ธันวาคม","sunday":"วันอาทิตย์","monday":"วันจันทร์","tuesday":"วันอังคาร","wednesday":"วันพุธ","thursday":"วันพฤหัสบดี","friday":"วันศุกร์","saturday":"วันเสาร์","sun":"อา","mon":"ของฉัน","tues":"ของคุณ","wed":"พุธ","thurs":"พฤ","fri":"ศ","sat":"ส","scheduleTime":"กำหนดเวลาของคุณ"}'
    )
  },
  function (e) {
    e.exports = JSON.parse(
      '{"selectTime":"Chọn thời gian","selectDate":"Chọn ngày","selectSlot":"Chọn một thời điểm từ các thời điểm có sẵn","chooseDate":"Ồ ... Tất cả các khe thời gian đã được lấp đầy trong ngày. Vui lòng chọn ngày khác","bookingConfirmed":"Đã xác nhận đặt lịch hẹn","addToCart":"Thêm vào giỏ hàng","updateInCart":"Cập nhật trong giỏ hàng","checkout":"Thủ tục thanh toán","allSelectedBookings":"Tất cả các đặt trước đã chọn","chooseVariant":"Chọn một biến thể","availableSlots":"Slots có sẵn","loading":"Đang tải","poweredBy":"Cung cấp bởi","redirectingToCheckout":"Chuyển hướng đến Checkout","confirmationText":"Đã thêm vào giỏ hàng- Xác nhận sẽ được gửi sau khi mua hàng","removeBooking":"Xóa Đặt chỗ","bookingRemoved":"Đặt trước đã bị xóa khỏi giỏ hàng","bookingConfirmation":"Xác nhận đặt phòng","back":"Trở lại","bookNow":"Đặt bây giờ","bookViaCalendly":"Đặt phòng Via Calendly","calendlyBookingError":"Calendly Error ... Nhấp vào liên kết trên để đặt","confirm":"Xác nhận","dateTime":"Ngày giờ","january":"tháng Giêng","february":"tháng 2","march":"tháng Ba","april":"Tháng tư","may":"có thể","june":"Tháng sáu","july":"Tháng bảy","august":"tháng Tám","september":"Tháng Chín","october":"Tháng Mười","november":"Tháng mười một","december":"Tháng mười hai","sunday":"chủ nhật","monday":"thứ hai","tuesday":"thứ ba","wednesday":"Thứ tư","thursday":"Thứ năm","friday":"Thứ sáu","saturday":"ngày thứ bảy","sun":"mặt trời","mon":"Của tôi","tues":"Của bạn","wed":"Thứ Tư","thurs":"Thứ năm","fri":"T6","sat":"Đã ngồi","scheduleTime":"Lên lịch thời gian của bạn"}'
    )
  },
  function (e, t) {
    let n = function (e) {
  ...
  function (e, t, n) {
    e.exports = (function (e) {
      ...
      var a = {
        ...
        monthsShort: 'Jan_Feb_März_Apr_Mai_Juni_Juli_Aug_Sept_Okt_Nov_Dez'.split(
          '_'
        ),
        ordinal: function (e) {
          return e + '.'
  ...
  function (e, t, n) {
    ...
    const i = {
      ...
      s = {
        '30-minutes-coaching.myshopify.com': {
          ...
          fr: { addToCart: 'RÉSERVEZ CE COACH' },
        ...
        'thornaes.myshopify.com': {
          da: {
            scheduleTime: 'Vælg en dato',
            slotsRemaining: 'ledige pladser',
            selectSlot: 'Vælg en dato og et tidsrum ovenfor',
          },
        },
        ...
        'green-doctors-ecuador.myshopify.com': {
          es: {
            chooseDate:
              'Oh no. Lo sentimos ya no hay citas disponibles este día, por favor elige otra fecha',
            availableSlots: 'Horas disponibles',
          },
        },
        'dyraland.myshopify.com': { is: { scheduleTime: 'Bóka' } },
    ...
    const F = {
        ...
        'mobila-biltvatt.myshopify.com': () => {
          setTimeout(() => {
            ...
            document.addEventListener('change', function () {
              ...
              ;(a = o ? a : o) &&
                n != a &&
                ((n = a), $('#appointo-custom-text').html('Hämtar...'), t(e[o]))
            }),
              document
                .getElementById('appointo-variant-select')
                .addEventListener('change', async (n) => {
                  $('#appointo-custom-text').html('Hämtar...'),
                    t(e[n.target.value])
                }),
              t('264821735593')
          }, 1e3)
        ...
        'udklaedningshop.myshopify.com': () => {
          ...
          e.length &&
            ($(
              `<div id="appointo-btn" style="\n          width: 100%; \n          background: #000000; \n          margin-bottom: 15px;\n          line-height: normal;\n          height: 50px;\n          color: white;\n          padding: 10px 45px;\n          display: flex;\n          align-items: center;\n          text-transform: uppercase;\n         " class="${e[0].classList.value}">Planlæg din tid</div>`
            ).insertAfter(e[0]),
            e[0].remove())
        },
